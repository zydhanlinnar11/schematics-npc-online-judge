...
favicon_paths = ['apple-icon-180x180.png', 'apple-icon-114x114.png', 'android-chrome-72x72.png',
                 'apple-icon-57x57.png', 'apple-icon-72x72.png', 'apple-icon.png', 'mstile-70x70.png',
                 'android-chrome-36x36.png', 'apple-icon-precomposed.png', 'apple-icon-76x76.png',
                 'apple-icon-60x60.png', 'android-chrome-96x96.png', 'mstile-144x144.png', 'mstile-150x150.png',
                 'safari-pinned-tab.svg', 'android-chrome-144x144.png', 'apple-icon-152x152.png',
                 'favicon-96x96.png',
                 'favicon-32x32.png', 'favicon-16x16.png', 'android-chrome-192x192.png', 'android-chrome-48x48.png',
                 'mstile-310x150.png', 'apple-icon-144x144.png', 'browserconfig.xml', 'manifest.json',
                 'apple-icon-120x120.png', 'mstile-310x310.png']
